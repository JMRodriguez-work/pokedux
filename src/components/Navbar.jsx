...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between overflow-hidden bg-stone-200 dark:bg-gray-800 dark:text-stone-200 w-screen px-10 w-ful z-50 py-2 h-[60px] items-center fixed top-0 shadow-md">
